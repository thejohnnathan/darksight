...
<template>
    <header class="topbar is-sticky glass">
        <div class="tb-left">
            <button class="is-hamburg" @click="sidebar()">
        ...
        <div class="tb-right">
            <button class="btn--primary ripple" onclick="window.open('https://www.github.com/thejohnnathan/darksight_v_1_1_x')">
